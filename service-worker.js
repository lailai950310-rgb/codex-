const CACHE_NAME = "vitality-fitness-v35";
const APP_SHELL = [
  "./",
  "./index.html",
  "./styles.css?v=35",
  ...
  "./assets/conditioning-shoe.png",
  "./assets/banner-strength-back.jpg",
  "./assets/banner-strength-portrait.jpg",
  "./assets/banner-strength-squat.jpg",
  "./assets/banner-strength-stretch.jpg",
